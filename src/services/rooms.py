...
from src.schemes.rooms import RoomAddRequest, Room, RoomAdd, RoomPatchRequest, RoomPatch
...
class RoomService(BaseService):
    async def get_filtered_by_time(
        ...
        check_date_to_after_date_from(data_from, date_to)
        return await self.db.rooms.get_filtered_by_time(
            hotel_id=hotel_id, data_from=data_from, date_to=date_to
        )
